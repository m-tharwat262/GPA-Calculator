...
public final class ExplorationContract {
    ...
    public static final String PATH_SEMESTER_GPA = "semester_gpa"; // table name for the semester gpa inside the uri path.



    // Class For the semester total gpa table in the database.
    public static final class SemesterGpaEntry implements BaseColumns {

        // the uri for the semester total gpa table in the database.
